...
function updateModalBodyState() {
    const anyOpen = Array.from(document.querySelectorAll('.modal')).some((modal) => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setChartSummary(dailyData) {
        ...
        todayMetaEl.textContent = peak.date === today.date ? '也是最近峰值' : '距峰值还有提升空间';
